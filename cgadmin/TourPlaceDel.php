...
if ((isset($_GET['tour'])) && ($_GET['tour'] != "") && (isset($_GET['place'])) && ($_GET['place'] != "")) {
  $deleteSQL = sprintf("DELETE FROM tbltoursplaces WHERE TourId=%s and PlaceId=%s",
  ...
  $deleteGoTo = "ToursAdminDetails.php";
